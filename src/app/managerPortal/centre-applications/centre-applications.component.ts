...
@Component({
  selector: 'app-centre-applications',
  templateUrl: './centre-applications.component.html',
...
export class CentreApplicationsComponent implements OnInit {
  ...
  constructor(private http: HttpClient,private fb: FormBuilder,private dataService: ApiService,private router:Router, private dialog: MatDialog) { 
    ...
    this.http.get('http://localhost:8080/FinalProj/php/Manager/fetchApplication.php').subscribe(data => {
      this.post.push(data);
