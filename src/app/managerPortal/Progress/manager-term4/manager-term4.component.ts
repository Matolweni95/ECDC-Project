...
@Component({
  selector: 'app-manager-term4',
  templateUrl: './manager-term4.component.html',
  styleUrls: ['./manager-term4.component.css']
})
export class ManagerTerm4Component implements OnInit {
