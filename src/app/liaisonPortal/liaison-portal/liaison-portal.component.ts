...
@Component({
  selector: 'app-liaison-portal',
  templateUrl: './liaison-portal.component.html',
  styleUrls: ['./liaison-portal.component.css']
})
export class LiaisonPortalComponent implements OnInit {
